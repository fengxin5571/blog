...
Route::group(['middleware'=>['auth','seckill']],function(){
    ...
    //秒杀验证接口
    Route::post('/seckill/check','SeckillController@checkSeckill')->name('seckill.check');
    //秒杀问答接口
    Route::post('/seckill/question','SeckillController@question')->name('seckill.question');
